...
public class CreateTimeRegistrationCommandValidator : AbstractValidator<CreateTimeRegistrationCommand>
{
    private readonly IApplicationDbContext _context;
    
    public CreateTimeRegistrationCommandValidator(IApplicationDbContext context)
    {
        _context = context;
